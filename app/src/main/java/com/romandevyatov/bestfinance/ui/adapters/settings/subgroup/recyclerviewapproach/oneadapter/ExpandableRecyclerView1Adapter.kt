package com.romandevyatov.bestfinance.ui.adapters.settings.subgroup.recyclerviewapproach.oneadapter
...
class ExpandableRecyclerView1Adapter(
    ...
    onSubGroupCheckedImpl: SubGroupsAdapter.OnSubGroupCheckedChangeListener? = null
    ...
    override fun getItemViewType(position: Int): Int {
        return when (items[position]) {
            ...
            is SubGroup3 -> VIEW_TYPE_SUBGROUP
        }
    }
