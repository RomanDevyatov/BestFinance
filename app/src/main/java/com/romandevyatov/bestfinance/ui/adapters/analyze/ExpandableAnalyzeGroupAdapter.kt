...
class ExpandableAnalyzeGroupAdapter(val parents: ArrayList<AnalyzeParentData>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val subParentModel: AnalyzeParentData = parents[position]
        ...
        val adapter: ExpandableSubParentAdapter
        when (subParentModel.type) {
            Constants.INCOMINGS_PARENT_TYPE -> {
                adapter = ExpandableSubParentAdapter(subParentModel.subParentNestedList?.map {
                    SubParentData(
            ...
            Constants.EXPENSES_PARENT_TYPE -> {
                adapter = ExpandableSubParentAdapter(subParentModel.subParentNestedListExpenses?.map {
