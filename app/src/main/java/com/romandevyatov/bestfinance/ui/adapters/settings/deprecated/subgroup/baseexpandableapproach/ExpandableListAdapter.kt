package com.romandevyatov.bestfinance.ui.adapters.settings.deprecated.subgroup.baseexpandableapproach
...
class ExpandableListAdapter(private val context: Context, private val group1s: List<Group1>) :
    ...
    override fun getChildView(groupPosition: Int, childPosition: Int, isLastChild: Boolean, convertView: View?, parent: ViewGroup?): View {
        ...
        if (view == null) {
            val inflater = context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
            view = inflater.inflate(R.layout.card_sub_groups, null)
        }
